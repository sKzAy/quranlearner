                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        <AlertDialogCancel onClick={async () => {
                          ...
                          let message = ""
                          let answer = await onLikeClick(numberSurah, verseNumber, message)
                          if (answer === 1){
                            toast.success("Added to liked verses!", {
                              unstyled: true,
                            ...
                            toast.success("Error,Try Later!", {
                              unstyled: true,
                              className: "bg-red-400 text-white border border-red-400 border-2 px-4 py-2 rounded-md flex gap-2 shadow items-center justify-center",
                            });
                          }
                        }}>Skip</AlertDialogCancel>
                        <AlertDialogAction className={"bg-red-500"} onClick={async () => {
