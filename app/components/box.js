...
import { Search,LibraryBooks,SpaceDashboardRounded } from '@mui/icons-material'
    ...
    { number === 1?
      <div className='flex flex-col bg-white w-fit h-fit p-10 rounded-3xl gap-4 hover:shadow-xl transition-all hover:transition-all duration-500'>
        ...
        <div className="btn text-center">
            <Link className='hover:text-black duration-500 tranistion-all hover:transition-all bg-gradient-to-r from-green-400 to-green-600 text-white p-3 rounded-xl' href={"/choose"}>Get Started <LibraryBooks/></Link>
        </div>
        ...
        <div className="btn text-center">
            <Link className='hover:text-black duration-500 tranistion-all hover:transition-all bg-gradient-to-r from-blue-400 to-blue-600 text-white p-3 rounded-xl' href={"/search"}>Get Started <Search/> </Link>
        </div>
        ...
        <div className="btn text-center">
            <Link className='hover:text-black duration-500 tranistion-all hover:transition-all bg-gradient-to-r from-red-400 to-red-600 text-white p-3 rounded-xl' href={"/dashboard"}>Get Started <SpaceDashboardRounded/> </Link>
        </div>
      </div> : <h1>nope</h1>}
    </>
  )
